...
path_class1 = preprocess_params['FIST']
path_class2 = preprocess_params['HAND']
path_class3 = preprocess_params['ONE']
path_class4 = preprocess_params['PEACE']
ALL_IMAGES_PATHS = [path_class1, path_class2, \
	path_class3, path_class4] #change here if you want to add new gesture
...
plt.imsave("./image.jpg", current_img_rs)
